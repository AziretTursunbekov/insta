...
const BASE_URL = "https://todo-list-bc35d-default-rtdb.firebaseio.com/.todos";

async function getTodos() {
  try {
    const response = await fetch(
      "https://hw-29js-default-rtdb.europe-west1.firebasedatabase.app/todos.json"
    );
    const data = await response.json();
...
async function postTodos() {
  ...
  try {
    const response = await fetch(
      "https://todo-list-bc35d-default-rtdb.firebaseio.com/todos.json",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
